  ...
  return (
    <div className="bg-white z-50">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-[#f7941f] px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0 items-center">
                <a href="#" className="flex items-center">
                  <span className="ml-2 font-bold text-[#f7941f] text-lg">
                    Shopit
                  </span>
                  <img
                    className="h-12 lg:h-12 w-auto"
                    src="https://raw.githubusercontent.com/Akhi111/ShoppingSite/master/src/assets/logo.png"
                    alt="Shopit Logo"
                  />
                </a>
              </div>
